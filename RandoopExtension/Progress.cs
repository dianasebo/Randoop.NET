using RandoopExtension.ToTestFrameworkConverter;
using System;
...
namespace RandoopExtension
{
    public partial class Progress : Form
    {
        ...
        public Progress(string testFrameworkName)
        {
        ...
        private void backgroundWorkerProgress_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            using (Process pRandoop = new System.Diagnostics.Process())
            {
        ...
        private void doWorkLeft()
        {
            ...
            TestFileCreator objToMsTest = new TestFileCreator();
            TestFrameworkEnum testFramework = (TestFrameworkEnum)Enum.Parse(typeof(TestFrameworkEnum), testFrameworkName);
            objToMsTest.Convert(out_dir, testFramework);
